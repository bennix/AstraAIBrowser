...
uploaded. For Build 81, for example:

```sh
scripts/generate_github_appcast.sh \
  --dmg releases/Astra-Browser-build81.dmg \
  --tag v1.0.81 \
...
```sh
gh release create v1.0.81 \
  releases/Astra-Browser-build81.dmg \
  releases/appcast.xml \
  --repo bennix/AstraAIBrowser \
  --title "Astra Browser 1.0 (Build 81)" \
