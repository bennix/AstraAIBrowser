(() => {
  const translations = {
    ...
    "download.summary": "Build 31 将隐私防护扩展到 Canvas、WebGL、WebAudio、本地字体探针、硬件信号和浏览器语言，同时保留应用内扩展、AI 助手、WebRTC 防泄漏及广泛的视频兼容性。DMG 已通过 Apple Developer ID 签名和 Apple 公证。"
  };
