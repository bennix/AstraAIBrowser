(() => {
  const translations = {
    ...
    "features.mediaCompatibility.body": "YouTube 保持 Chromium 的 VP9/AV1 播放路径；需要 H.264、AAC 或 HLS 时使用内嵌系统媒体引擎。X 默认保持 Chromium 以运行扩展，只在可见视频无法解码时临时切换。",
    ...
    "download.summary": "Build 45 将内嵌 Chromium 升级到 151，支持 Chrome 应用商店扩展留在 Astra 内，避免通用页面重写导致 Google 搜索结果卡死，并兼顾 X 扩展运行与视频自动兼容回退。DMG 已通过 Apple Developer ID 签名和 Apple 公证。"
  };
