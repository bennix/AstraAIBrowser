...
[Download Astra 1.0 (build 55)](https://github.com/bennix/AstraAIBrowser/releases/download/v1.0.55/Astra-Browser-build55.dmg)
· [Product page](https://bennix.github.io/AstraAIBrowser/)
· [Release notes](https://github.com/bennix/AstraAIBrowser/releases/tag/v1.0.55)
...
- X and Twitter image viewers support native macOS trackpad pinch, wheel, and double-click zoom up to 8×, with drag-to-pan and automatic reset when the viewer closes or changes media.
