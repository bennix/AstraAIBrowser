...
[Download Astra 1.0 (build 54)](https://github.com/bennix/AstraAIBrowser/releases/download/v1.0.54/Astra-Browser-build54.dmg)
· [Product page](https://bennix.github.io/AstraAIBrowser/)
· [Release notes](https://github.com/bennix/AstraAIBrowser/releases/tag/v1.0.54)
...
- X and Twitter image viewers support trackpad pinch, wheel, and double-click zoom up to 8×, with drag-to-pan and automatic reset when the viewer closes or changes media.
