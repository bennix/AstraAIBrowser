...
struct ImmersiveTranslationPopover: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(NSLocalizedString(
                "translation.popover.manualOnlyNotice",
                value: "Pages are translated only when you choose Translate Page. Opening or switching tabs never starts translation.",
                comment: "Immersive translation - Explain that translation requires an explicit action"
            ))
            .font(.caption)
